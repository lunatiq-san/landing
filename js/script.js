...
//       hours1 +
//       hours2 +
//       "</div><div class='countbox-hours-text'>Р§Р°СЃРѕРІ</div></div>" +
//       "<div class='countbox-num'><div class='countbox-mins'><span></span>" +
//       mins1 +
//       mins2 +
//       "</div><div class='countbox-mins-text'>РњРёРЅСѓС‚</div></div>" +
//       "<div class='countbox-num'><div class='countbox-secs'><span></span>" +
//       secs1 +
//       secs2 +
//       "</div><div class='countbox-secs-text'>РЎРµРєСѓРЅРґ</div></div>";
//     var list = document.getElementsByClassName("countbox");
//     for (var i = 0; i < list.length; i++) {
//       list[i].innerHTML = out;
//     }
